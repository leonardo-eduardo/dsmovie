...
alter table if exists tb_score add constraint fk_score_movie foreing key (movie_id) references tb_movie;
alter table if exists tb_score add constraint fk_score_user foreing key (user_id) references tb_user;
